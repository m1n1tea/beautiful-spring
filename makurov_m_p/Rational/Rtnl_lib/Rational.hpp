...
public:
	...
	Rational(const int64_t& num) noexcept;//убрал explicit, чтобы не писать смешанную арифметику для целых чисел
	~Rational() = default;
	...
	const int64_t& getNum() const noexcept;
	const int64_t& getDenum() const noexcept;
